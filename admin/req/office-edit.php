    ...
    if ($_SESSION['role'] == 'Admin') {
        ...
        if (
            ...
            if (empty($fname)) {
                ...
                $sql = "UPDATE register_office SET username=?, fname=?, lname=?, address=?, employee_number=?, date_of_birth=?, phone_number=?, qualification=?, gender=?, email_address=?
                WHERE r_user_id=?";
                ...
                header("Location: ../office-edit.php?success=$sm&$data");
                exit;
            }
        } else {
            $em = "An error occurred";
            header("Location: ../office-edit.php?error=$em");
            exit;
        }
    } else {
