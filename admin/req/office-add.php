    ...
    if ($_SESSION['role'] == 'Admin') {
        ...
        if (
            ...
            if (empty($fname)) {
                ...
                header("Location: ../office-add.php?error=$em&$data");
                exit;
            } else if (empty($lname)) {
                ...
                $query = "INSERT INTO register_office (username, password, fname, lname, address, employee_number, date_of_birth, phone_number, qualification, gender, email_address) VALUES(?,?,?,?,?,?,?,?,?,?,?);";
                ...
                $sm = "New Register Office User successfully created";
                header("Location: ../office-add.php?success=$sm");
                exit;
            }
        } else {
            $em = "An error occurred";
            header("Location: ../office-add.php?error=$em");
            exit;
        }
    } else {
