...
?>
        ...
        <head>
            ...
            <title>Admin - Add Register Office User</title>
            <!-- BOOTSTRAP -->
        ...
        <body>
            ...
            <main class="main-wrap">
                ...
                <div class="move-left container mt-5">
                    ...
                    <form method="POST" class="shadow p-3 mt-4" action="req/office-add.php">
                        <div class=" form-group form-w">
                            <h3 class="mt-1">Add New Register Office User</h3>
